...
register_pascal_voc('datetime_dataset_train', dirname='datasets_date_rec', split='train', CLASS_NAMES=["signature","others","datetime"])

visualize_dataset('datetime_dataset_train',n_samples = 1)